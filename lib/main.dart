...
class SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _decideNavigation() async {
    ...
    final sessionExpiryString = prefs.getString('sessionExpiry');
    final sessionExpiry = sessionExpiryString != null
        ? DateTime.tryParse(sessionExpiryString)
        : null;
    ...
    } else if (sessionExpiry != null && sessionExpiry.isAfter(DateTime.now())) {
      // ✅ Already logged in
